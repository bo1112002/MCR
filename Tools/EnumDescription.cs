...
namespace Tools
{
    ...
    public class EnumDescription_Bool : EnumDescription
    {
        public EnumDescription_Bool(string text):base(text)
        {
        }

        bool _IsCheck = false;
        /// <summary>是否选择中</summary>
        public bool IsCheck
        {
            get { return _IsCheck; }
            set { _IsCheck = value; }
