...
namespace Tools
{
    public sealed class Regexs
    {
        ...
        /// 验证身份证号(15位或18位数字)
        /// </summary>
        public static bool IsIdentityON(string str)
        {
        ...
        {
            return Regex.IsMatch(str, @"^[a-zA-Z0-9]{6,20}$");
        }
        /// <summary>
        /// 验证用户密码：以字母开头，长度在6~20之间，只能包含字符、数字和下划线
        /// </summary>
        public static bool IsPassword(string str)
        {
            return Regex.IsMatch(str, @"^[a-zA-Z]\w{5,21}$");
        }
        /// <summary>
        /// 验证用户名：以字母开头，长度在6~18之间，只能包含字符、数字和下划线
        /// </summary>
        public static bool IsLoginName(string str)
        {
            return Regex.IsMatch(str, @"^[a-zA-Z]\w{5,17}$");
        }
